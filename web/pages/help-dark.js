...
export default function HelpDark() {
  ...
  return (
    <div className="min-h-screen bg-[#000000] flex items-center justify-center p-4">
      <div className="bg-[#1c1c1e] rounded-[30px] shadow-[0px_4px_20px_0px_rgba(0,0,0,0.08)] p-6 md:p-8 max-w-[800px] w-full">
        
        {/* Header */}
        <div className="text-center mb-8">
          <h1 className="text-2xl md:text-3xl font-semibold text-white mb-2">Help & Support</h1>
        ...
        <div className="space-y-4 mb-8">
          {faqItems.map((item, index) => (
            <motion.div
              ...
              className="bg-[#2c2c2e] rounded-[20px] p-6"
            >
              <div 
        ...
        {/* Contact Information */}
        <div className="bg-[#2c2c2e] rounded-[20px] p-6 mb-8">
          <h3 className="text-lg font-semibold mb-4 text-white">Still Need Help?</h3>
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="font-medium text-white">Discord Community</div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-sm text-gray-400">Read our guides</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex gap-4">
          <motion.button
            ...
            className="flex-1 bg-[#2c2c2e] text-white py-4 rounded-[20px] text-lg font-medium hover:bg-[#3c3c3e] transition-colors"
          >
            Claim/Refund
          </motion.button>
          ...
          <motion.button
            ...
            className="flex-1 bg-white text-black py-4 rounded-[20px] text-lg font-medium hover:bg-gray-200 transition-colors"
          >
            Back to Home
          </motion.button>
        </div>
