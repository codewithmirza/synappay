  ...
  return (
    <div className="min-h-screen bg-[#f2f2f7] flex items-center justify-center p-4">
      <div className="bg-[#ffffff] rounded-[30px] shadow-[0px_4px_20px_0px_rgba(0,0,0,0.08)] p-8 max-w-[800px] w-full">
        ...
        <div className="space-y-4 mb-8">
          {faqItems.map((item, index) => (
            <motion.div
              ...
              className="bg-[#f2f2f7] rounded-2xl p-4"
            >
              <div 
                className="flex justify-between items-center cursor-pointer"
                onClick={() => toggleItem(item.id)}
              >
                <h3 className="text-[#000000] text-[18px] font-['Inter:Regular',_sans-serif] font-normal leading-[27px]">
                  {item.question}
                </h3>
                <motion.div
              ...
              >
                <p className="text-[16px] text-[rgba(0,0,0,0.7)] font-['Inter:Regular',_sans-serif] font-normal leading-[24px] mt-4">
                  {item.answer}
                </p>
              </motion.div>
            </motion.div>
        ...
        {/* Footer Links */}
        <div className="border-t border-[#f2f2f7] pt-6">
          <div className="flex justify-center gap-6">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[#007aff] text-[14px] font-['Inter:Regular',_sans-serif] font-normal leading-[21px]">
                Documentation
              </span>
            </div>
        ...
        <div className="fixed bottom-6 right-6">
          <motion.button
            ...
            whileTap={{ scale: 0.9 }}
            className="bg-[#007aff] text-white p-4 rounded-full shadow-[0px_4px_16px_0px_rgba(0,0,0,0.15)]"
          >
            <div className="w-6 h-6 relative">
              <svg className="w-full h-full" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
              </svg>
              <div className="absolute -top-1 -right-1 bg-[#34c759] opacity-50 p-1 rounded-full">
